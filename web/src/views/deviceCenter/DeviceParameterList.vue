	  	...
	  	<el-container class="rightContainer" v-if="!paramsAddAndEditVisble">
	        ...
	        <div class="container">
	            <el-table :data="oChioceObject.attrDetails" class="table" ref="multipleTable" height="330" empty-text="暂无数据">
	                <el-table-column prop="attr" label="名称" align="center" width="250"></el-table-column>
	                <el-table-column prop="dataType" label="字符类型"  align="center" width="200"></el-table-column>
	                <el-table-column prop="unit" label="单位" align="center" min-width="250"></el-table-column>
	                <el-table-column prop="dataLength" label="最大字符长度" align="center" min-width="250"></el-table-column>
	            </el-table>
	        </div>
	   </el-container>
