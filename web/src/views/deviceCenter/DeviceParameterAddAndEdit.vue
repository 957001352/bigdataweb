                ...
                <div class="formText">
                    <el-form label-position="top" :model="ruleForm" :rules="rules" ref="ruleForm" label-width="10px" class="submitForm">
                        ...
                        <el-form-item label="描述" prop="describe">
                            <el-input type="textarea" v-model="ruleForm.describe" placeholder="请输入描述(2~50个字符)"  show-word-limit></el-input>
                        </el-form-item>
                    </el-form>
                </div>
            </div>
			...
			saveParameterRequest() {
	    		...
	    		this.$axios.leansite({
                    ...
                    if(resData.code == 0){
						...
						self.$emit("ParameterEditCallBack",true);
						...
						this.$message({
			          	...
			          	self.$message({
				            type: 'error',
				            message: this.pageType+'参数失败，请退出重试！'
			          	});
                    }
                }).catch((err) => {
		          	self.$message({
