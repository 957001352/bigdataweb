                ...
                <div class="formText">
                    <el-form label-position="top" :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
                        <el-form-item label="角色名称" prop="name">
                            <el-input v-model="ruleForm.name" placeholder="请输入角色名称(2~50个字符)"></el-input>
                        </el-form-item>
                        <el-form-item label="角色描述" prop="note">
                            <el-input type="textarea" v-model="ruleForm.note"  placeholder="请输入角色描述(2~50个字符)"></el-input>
                        </el-form-item>
                    </el-form>
                </div>
            </div>
