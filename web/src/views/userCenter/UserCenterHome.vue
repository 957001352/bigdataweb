    ...
    data() {
        return {
            oldAsideList: [//原始侧边栏菜单
                {
                    icon: [
                    	require('../../assets/img/userCenter/zuzhijiagou-wxz.png'),
                ...
                {
                    icon: [
                        require('../../assets/img/userCenter/jueseguanli-wxz.png'),
            	...
            	{
                    icon: [
                        require('../../assets/img/userCenter/yonghu-wxz.png'),
              ...
              {
                    icon: [
                        require('../../assets/img/userCenter/huodongrizhi-wxz.png'),
