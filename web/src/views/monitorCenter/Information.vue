			...
			<div class="container">
				<div class="baseMessage">
					<div class="baseMessage_left">
						<img src="../../assets/img/defaultImg.png" alt="设备图片"/>
					</div>
					<div class="baseMessage_right">
						<span>类型：注塑机</span>
						<span>描述：900吨注塑机嘀咕嘀咕嘀咕的嘀咕嘀咕嘀咕的嘀咕嘀咕嘀咕的嘀咕嘀咕嘀咕的嘀咕嘀咕嘀咕的嘀咕嘀咕嘀咕的嘀咕嘀咕嘀咕的嘀咕嘀咕嘀咕的嘀咕嘀咕嘀咕的嘀咕嘀咕嘀咕的嘀咕嘀咕嘀咕的</span>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="container">
				<div class="position">
					...
					<div class="position_right">
						<img src="../../assets/img/denglu-beijing.png" alt="位置信息图片"/>
					</div>
				</div>
			</div>
		</div>
